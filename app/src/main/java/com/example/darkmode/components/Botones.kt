package com.example.darkmode.components
...
import com.example.darkmode.StoreMode
...
@Composable
fun DarkMode( darkMode: MutableState<Boolean>, dataStore: StoreMode  ) {
    val scope = rememberCoroutineScope()

    Button( onClick = {
        darkMode.value = !darkMode.value
        scope.launch { dataStore.saveMode ( darkMode.value ) }
    }
    ) {
